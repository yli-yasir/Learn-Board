  ...
  return (
    <LanguageContext.Consumer>
      {langContext => {
        ...
        return (
          <FormPage
            formTitle={strings.newPost}
            submitButtonLabel={strings.post}
            submitButtonTip={strings.submitPostTooltip}
          ...
          >
            ...
            <TextField
              ...
              margin="normal"
              multiline
              helperText={strings.shortDescriptionHelp}
            />
            ...
            <TextField
              ...
              margin="normal"
              multiline={true}
              helperText={strings.descriptionHelp}
            />
            {/*end of description */}

            {/*city */}
            <FormControl className={classes.formControl}>
              <InputLabel htmlFor="cities">{strings.city}</InputLabel>
              <Select
                value={city}
              ...
              <FormHelperText>{strings.cityHelp}</FormHelperText>
            </FormControl>
            {/*end of city */}

            {/*languages*/}
            <FormControl className={classes.formControl}>
              <InputLabel htmlFor="languages">{strings.addLanguage}</InputLabel>
              <Select
              ...
              <FormHelperText>{strings.addLanguageHelp}</FormHelperText>
            </FormControl>
            ...
            <Box className={classes.selectionContainer}>
              {Object.keys(postIcons).map(key => {
                ...
                const selectedIconClass =
                  iconDoc.name === selectedIconName ? classes.selectedIcon : "";
                return (
                  <Tooltip title={iconDoc.alt}>
                    <Button
                      ...
                      key={iconDoc.name}
                      className={
                        classes.postIconContainer + " " + selectedIconClass
                      }
                      onClick={() => {
            ...
            >
              <DialogTitle id="alert-dialog-title">
                {strings.peopleCantContact}
              </DialogTitle>
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  {strings.provideContactInfo}
                </DialogContentText>
              </DialogContent>
              <DialogActions>
                <Button
                  onClick={handleMissingUserInfoDialogClose}
                  color="primary"
                >
                  OK
                </Button>
                ...
                >
                  <Button color="primary" autoFocus>
                    {strings.goUserSettings + ' ' + strings.openInNewTab}
                  </Button>
                </Link>
              </DialogActions>
            </Dialog>
